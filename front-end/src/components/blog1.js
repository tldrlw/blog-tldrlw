    ...
    <main>
      ...
      <section className='mb-2 text-sm text-gray-700 md:mb-4 md:text-base'>
        <p className='mb-2 text-gray-700 md:mb-4'>
          ...
          ECS, I assume you have a basic understanding of Terraform, setting up
          an IAM User with a Secret Key and Secret Access Key to run Terraform
          code against your AWS account, and a basic understanding of CI/CD
          pipelines written in YAML. Code references for everything we will do
          can be found{' '}
          <a
        ...
        <p className='mb-2 text-gray-700 md:mb-4'>
          ...
          the remote backend. After you&apos;ve created the remote backend
          resources, you&apos;ll need to reference them in the remote backend
          you&apos;ll be setting up for this project. Your provider.tf should
          look like this:
        </p>
        <CodeBlock
