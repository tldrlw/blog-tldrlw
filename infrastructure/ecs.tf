...
module "ecs_service" {
  ...
  host_port                   = 3000
  # linux_arm64                 = true
  # ^ set to true if building and pushing images to ECR on M-series Macs: https://github.com/tldrlw/blog-tldrlw/blob/boilerplate-nextjs/front-end/docker-push.sh
}
