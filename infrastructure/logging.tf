# module "logging" {
#   source                       = "git::https://github.com/tldrlw/terraform-modules.git//logging"
...
#   LOG_GROUPS = [
#     {
#       log_group     = "/aws/lambda/monza-tldrlw-get",
#       friendly_name = "lambda-monza-get",
#       arn           = data.aws_cloudwatch_log_group.lambda_monza_tldrlw_get.arn
#     },
#     {
